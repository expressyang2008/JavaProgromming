 ...
 * @description: This file declares several constants that are shared by the  different modules in the NameSurfer application.  Any class   that implements this interface can use these constants.
 * @version: 0.1.0
 * @author: Shawn Yang
