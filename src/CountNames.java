 ...
 * @description: This program shows an example of using a HashMap. It reads a  list of names from the user and list out how many times each name  appeared in the list.
 * @version: 0.1.0
 * @author: Shawn Yang
 * @create: 2021-10-25 10:02
 */
