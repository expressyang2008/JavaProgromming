 ...
 * @description: When it is finished, this program will implements the viewer for  the baby-name database described in the assignment handout.
 * @version: 0.1.0
 * @author: Shawn Yang
 * @create: 2021-11-18 15:08
 */
...
public class NameSurfer extends Program implements NameSurferConstants {
    ...
    public void init() {
        ...
        addControlBar();
        namesDataBase = new NameSurferDataBase("files/names-data.txt");
