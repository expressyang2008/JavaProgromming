 ...
 * @description: This class represents a single entry in the database.  Each
 * NameSurferEntry contains a name and a list giving the popularity  of that
 * name for each decade stretching back to 1900.
 * @version: 0.1.0
 * @author: Shawn Yang
