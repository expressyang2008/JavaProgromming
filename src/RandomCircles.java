 ...
 * @description: This program draws a set of 10 circles with different sizes, * positions, and colors. Each circle has a randomly chosen * color, a randomly chosen radius between 5 and 50 pixels, * and a randomly chosen position on the canvas, subject to * the condition that the entire circle must fit inside the * canvas without extending past the edge.
 * @version: 0.1.0
 * @author: Shawn Yang
 * @create: 2021-09-20 00:34
 */
import acm.program.*;
import acm.graphics.*;
import acm.util.*;
